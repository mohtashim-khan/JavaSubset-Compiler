...
#line 210 "parser.tab.hpp"
    ...
    T_CESC_R = 264,                // T_CESC_R
    T_CESC_N = 265,                // T_CESC_N
    ...
    struct symbol_kind
    {
      enum symbol_kind_type
      {
        ...
        S_T_CESC_R = 9,                          // T_CESC_R
        S_T_CESC_N = 10,                         // T_CESC_N
        ...
        S_start = 47,                            // start
        S_literal = 48,                          // literal
        S_type = 49,                             // type
        S_globaldeclarations = 50,               // globaldeclarations
        S_globaldeclaration = 51,                // globaldeclaration
        S_variabledeclaration = 52,              // variabledeclaration
        S_identifier = 53,                       // identifier
        S_functiondeclaration = 54,              // functiondeclaration
        S_functionheader = 55,                   // functionheader
        S_functiondeclarator = 56,               // functiondeclarator
        S_formalparameterlist = 57,              // formalparameterlist
        S_formalparameter = 58,                  // formalparameter
        S_mainfunctiondeclaration = 59,          // mainfunctiondeclaration
        S_mainfunctiondeclarator = 60,           // mainfunctiondeclarator
        S_block = 61,                            // block
        S_blockstatements = 62,                  // blockstatements
        S_blockstatement = 63,                   // blockstatement
        S_statement = 64,                        // statement
        S_statementexpression = 65,              // statementexpression
        S_primary = 66,                          // primary
        S_argumentlist = 67,                     // argumentlist
        S_functioninvocation = 68,               // functioninvocation
        S_postfixexpression = 69,                // postfixexpression
        S_unaryexpression = 70,                  // unaryexpression
        S_multiplicativeexpression = 71,         // multiplicativeexpression
        S_additiveexpression = 72,               // additiveexpression
        S_relationalexpression = 73,             // relationalexpression
        S_equalityexpression = 74,               // equalityexpression
        S_conditionalandexpression = 75,         // conditionalandexpression
        S_conditionalorexpression = 76,          // conditionalorexpression
        S_assignmentexpression = 77,             // assignmentexpression
        S_assignment = 78,                       // assignment
